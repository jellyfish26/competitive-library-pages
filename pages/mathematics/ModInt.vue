...
import DependentList from '~/locales/mathematics/ModInt/list.js'
import Japanese from '~/locales/mathematics/ModInt/ja.json'
import English from '~/locales/mathematics/ModInt/en.json'
